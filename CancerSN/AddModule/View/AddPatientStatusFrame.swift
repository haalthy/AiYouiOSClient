...
let patientStatusDateLabelFont: UIFont = UIFont.systemFont(ofSize: 13)
...
let patientStatusDateBtnFont: UIFont = UIFont.systemFont(ofSize: 13)
...
let symptomsFont: UIFont = UIFont.systemFont(ofSize: 13)
...
let symptomDespFont: UIFont = UIFont.systemFont(ofSize: 15)

//add more buttom
let addReportButtonLeftSpace = CGFloat(15)
let addReportButtonText: String = String("请输入医院报告")
let addReportButtonFont: UIFont = UIFont.systemFont(ofSize: 15)
...
let reportListTitleFont: UIFont = UIFont.systemFont(ofSize: 13)
...
let scanReportDespFont: UIFont = UIFont.systemFont(ofSize: 15)
