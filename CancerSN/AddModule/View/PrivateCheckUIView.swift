...
class PrivateCheckUIView: UIView {
    ...
    */
    ...
    func createCheckedSection()->UIView{
        checkedSectionView = UIView(frame: CGRect(x: 0, y: UIScreen.main.bounds.height - buttomSectionHeight, width: screenWidth, height: buttomSectionHeight))
        checkedSectionView.backgroundColor = UIColor.white
