...
//        let addViewController = storyboard.instantiateViewControllerWithIdentifier("AddEntry") as! AddItemViewController
//        addViewController.view.backgroundColor = UIColor(red: 0, green: 0, blue: 0, alpha: 0.3)
...
//        topVC!.view.addSubview(blurEffectView)
//        addViewController.view.alpha = 0.6
