...
class CVCalendarWeekContentViewController: CVCalendarContentViewController {
    ...
    func insertWeekView(_ weekView: WeekView, withIdentifier identifier: Identifier) {
    ...
    func replaceWeekView(_ weekView: WeekView, withIdentifier identifier: Identifier, animatable: Bool) {
...
extension CVCalendarWeekContentViewController {
    func getPreviousWeek(_ presentedWeekView: WeekView) -> WeekView {
    ...
    func getFollowingWeek(_ presentedWeekView: WeekView) -> WeekView {
...
extension CVCalendarWeekContentViewController {
    func prepareTopMarkersOnWeekView(_ weekView: WeekView, hidden: Bool) {
...
//            dayView.topMarker?.hidden = hidden
    ...
    func updateSelection() {
        ...
        if let presentedWeekView = weekViews[Presented], let presentedMonthView = monthViews[Presented] {
            ...
            if let selected = coordinator?.selectedDayView, !matchedWeeks(selected.date, presentedDate) {
    ...
    func selectDayViewWithDay(_ day: Int, inWeekView weekView: WeekView) {
        let coordinator = calendarView.coordinator
        weekView.mapDayViews { dayView in
